...
We assume that the inputs $x$ are sampled from some data distribution $x\sim \mathcal{D}$, and
...
the entire data distribution $\mathcal{D}$ instead of just on the $P$ sampled data points.
