...
\begin{itemize}
    ...
    been learned yet), and it's a saddle because stepping away from it along any mode's downhill direction lowers the loss.
...
Which way does it go? Recall that each mode's downhill steepness is
